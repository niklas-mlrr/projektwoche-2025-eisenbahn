/* autogenerated by Processing revision 1293 on 2025-10-07 */
...
public class Processing_GUI extends PApplet {
...
public void angle(float val) {
  if (!Float.isNaN(val)) {
    angle = constrain(PApplet.parseInt(val), 0, 180);
  }
}
...
public void bueAuf() {
  ...
  public void settings() { size(500, 320); }

  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Processing_GUI" };
    if (passedArgs != null) {
